...
Route::middleware(['auth'])->group(function(){
    ...
    //admin
    // Route::get(['middleware' => 'admin_auth'],function(){
    ...
    Route::middleware(['admin_auth'])->group(function(){
        ...
        Route::prefix('user')->group(function(){
            Route::get('list',[UserlistsController::class,'userList'])->name('admin#userList');
            Route::get('change/role',[UserlistsController::class,'changeRole'])->name('admin#useChangeRole');
            Route::get('customer/message',[UserlistsController::class,'customerMessage'])->name('admin#customerMessage');
        });
    });
