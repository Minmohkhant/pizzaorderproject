                ...
                <div class="col-md-12">
                    ...
                    <div class="row mt-2">
                        <div class="col-1 offset-10 bg-white shadow-sm p-2 text-center">
                            <h3> <img style="width: 25px" class="me-3" src="https://img.icons8.com/ios-glyphs/30/000000/product.png"/> {{ $pizzas->total() }} </h3>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2 text-center">
                                    ...
                                    <tbody>
                                        @foreach ($pizzas as $p)
                                        <tr class="tr-shadow">
                                            <td class="col-2"><img src="{{ asset('storage/' .$p->image ) }}" class=" rounded shadow-sm"></td>
