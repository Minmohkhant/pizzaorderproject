                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('product#list') }}" class="text-decoration-none">
                                <img style="width: 20px" class="me-3" src="https://img.icons8.com/ios-glyphs/30/000000/product.png"/>Products</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin#customerMessage') }}" class="text-decoration-none">
                                <i class="fa-solid fa-envelope"></i>Customer Messages</a>
                        </li>
                    </ul>
                </nav>
            </div>
